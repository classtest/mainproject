...
office365ConnectorSend color: "00ff00", message: "Build Success - ${env.JOB_NAME} - Build #${env.BUILD_NUMBER} (<${env.BUILD_URL}|Open>) | (<${env.BUILD_URL}console|Console>) | (<${env.BUILD_URL}changes|Changes>)", status:"00ff00:Success", webhookUrl: 'https://outlook.office.com/webhook/0ddd5e7a-369c-4d0c-864c-5c70e740841c@732bb72b-3edd-4f6e-bb42-067f4dcffa63/JenkinsCI/844c8d41c7de4d7aae4bcec1ff6e2262/0c4b9b8a-c2ba-4b97-b3fd-74879df16998'
}
        failure {
